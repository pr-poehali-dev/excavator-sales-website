  ...
  const models = [
    {
      ...
      features: ['Джойстиковое управление – интегрированное в поворотное кресло оператора', 'SRS система гашения колебаний', 'Мосты и КПП CARRARO', 'Литая каретка экскаваторной стрелы']
    },
    {
      name: 'LONKING 84C',
