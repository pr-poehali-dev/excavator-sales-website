  ...
  const models = [
    {
      ...
      specs: [
        ...
        { label: 'Высота выгрузки по шарниру', value: '3 300 мм' },
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="grid md:grid-cols-2 gap-8 items-start">
            ...
            <div className="relative hidden md:block">
              ...
              <div className="relative z-10 bg-lonking-yellow/20 border-2 border-lonking-yellow rounded-xl p-6 backdrop-blur-sm" style={{ transform: 'translateY(50px)' }}>
