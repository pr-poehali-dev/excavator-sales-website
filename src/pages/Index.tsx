  ...
  const models = [
    {
      ...
      features: ['Компактные размеры', 'Универсальность', 'Экономичность', 'SRS система гашения колебаний']
    },
    {
      name: 'LONKING 84C',
      ...
      features: ['Увеличенная мощность', 'Больше производительность', 'Современные технологии', 'SRS система гашения колебаний']
    }
  ];
