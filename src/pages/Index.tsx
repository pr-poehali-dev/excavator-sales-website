      ...
      <header className="bg-lonking-black text-white py-4 sticky top-0 z-50 shadow-lg">
        <div className="container mx-auto px-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <img src="https://cdn.poehali.dev/files/d9de8a4d-a9fc-4a80-900f-ec30f88df564.png" alt="LONKING" className="h-30 md:h-36" />
      ...
      <footer className="bg-lonking-black text-white py-8">
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <img src="https://cdn.poehali.dev/files/d9de8a4d-a9fc-4a80-900f-ec30f88df564.png" alt="LONKING" className="h-30" />
