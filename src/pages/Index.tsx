  ...
  const models = [
    {
      ...
      features: ['Джойстиковое управление – интегрированное в поворотное кресло оператора', 'Телескопическая рукоять экскаваторной стрелы с гидролиниями для молота и бура', 'Аксиально-поршневой насос BOSH REXROTH', 'SRS система гашения колебаний', 'Мосты и КПП CARRARO', 'Литая каретка экскаваторной стрелы', 'Плавающий ковш', 'LED–оптика и подсветка ступеней', 'Безопасная и комфортная кабина ROPS/FOPS']
    },
    {
      name: 'LONKING 84C',
